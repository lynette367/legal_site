...
export function PricingContent() {
  ...
  return (
    <>
      {/* Targeted conversion banner */}
      {toolName && (
        <div className="mb-8 rounded-3xl border-2 border-primary-lavender bg-white p-8 text-center shadow-xl animate-in fade-in slide-in-from-top-4 duration-700">
          <h2 className="text-2xl font-bold text-text-primary">
            Finish your <span className="text-primary-lavender">{toolName}</span> report
          </h2>
          <p className="text-text-primary/70 mt-2 text-lg">
            Choose a plan below to unlock instant access to your professional compliance analysis.
          </p>
        </div>
      )}
