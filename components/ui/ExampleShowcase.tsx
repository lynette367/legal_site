...
export function ExampleShowcase({ inputExample, outputBlocks, title = "示例回答" }: ExampleShowcaseProps) {
  return (
    <section className="rounded-3xl border border-border-lavender bg-bg-card p-8 shadow-soft">
      <h2 className="text-2xl font-semibold text-text-primary mb-6">使用示例</h2>
      
      <div className="space-y-6">
        <div>
          <p className="text-sm font-semibold text-text-lavender mb-2">输入示例</p>
        ...
        <div>
          <p className="text-sm font-semibold text-text-lavender mb-4">输出示例</p>
